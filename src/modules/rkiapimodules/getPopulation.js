...
function getPopulation(typ, regionID){
            ...
            */
            ...
            https.get(fertigeUri, (res) => {
                ...
                res.on("end", () => {
                    ...
                    switch (typ) {
                        case 1:
                            resolve(parsedData.features[0].attributes.EWZ);
                            break;
                        case 2:
                            resolve(parsedData.features[0].attributes.LAN_ew_EWZ);
                            break;
                        case 3:
                            let ergebnis = 0;
                            for (let i = 0; i < 16; i++) {
            ...
            reject(new Error('500 Internal Server Error (getPopulation)'));
        }
    })
}
